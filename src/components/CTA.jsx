export default function CTA() {
  return (
    <>
      {/* CTA */}
      <section id="kontakt" className="relative overflow-hidden bg-[#f97316] py-24 text-white">
        ...
        <div className="relative mx-auto max-w-4xl px-5 text-center lg:px-8">
          ...
          <div className="mt-10 flex flex-col justify-center gap-4 sm:flex-row">
            ...
            <a href="tel:90591820" className="rounded-full border-2 border-white px-8 py-4 font-bold text-white transition hover:-translate-y-1 hover:bg-white/10">Ring 905 91 820</a>
          </div>
        </div>
      </section>
    </>
