    ...
    <>
      ...
      <section id="webdesign" className="bg-slate-50 py-24 text-slate-950">
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 lg:grid-cols-2 lg:px-8">
          <div>
            <p className="text-sm font-bold uppercase tracking-[0.3em] text-[#c2410c]">Webdesign</p>
          ...
          <div className="rounded-[2rem] bg-white p-5 shadow-2xl ring-1 ring-slate-200">
            <div className="overflow-hidden rounded-[1.5rem] border border-slate-200 bg-slate-950 text-white">
              ...
              <div className="p-6">
                <div className="rounded-3xl bg-gradient-to-br from-[#f97316] via-cyan-300 to-blue-500 p-8 text-slate-950">
                  ...
                  <button className="mt-6 rounded-full bg-[#f97316] px-6 py-3 font-bold text-white">Kontakt oss</button>
                </div>
...
function Check({ text }) {
  return (
    <div className="flex items-center gap-3 rounded-2xl bg-white p-4 shadow-sm ring-1 ring-slate-200">
      <span className="flex h-8 w-8 items-center justify-center rounded-full bg-orange-100 font-black text-[#c2410c]">✓</span>
